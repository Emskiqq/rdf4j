...
import org.eclipse.rdf4j.testsuite.rio.rdfxml.RDFXMLParserTestCaseLegacy;
 ...
 */
public class RDFXMLParserTestLegacy extends RDFXMLParserTestCaseLegacy {

	public static Test suite() throws Exception {
		return new RDFXMLParserTestLegacy().createTestSuite();
	}
