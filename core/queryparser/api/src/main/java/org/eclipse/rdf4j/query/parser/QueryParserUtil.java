...
public class QueryParserUtil {
	...
	public static QueryParser createParser(QueryLanguage ql, VersionLabel qlVersion)
	...
	public static ParsedOperation parseOperation(QueryLanguage ql, String operation, String baseURI)
		...
		return parseOperation(ql, null, operation, baseURI);
	}
	 ...
	 * @throws UnsupportedQueryLanguageException If the specified query language is not supported.
	 */
	public static ParsedOperation parseOperation(QueryLanguage ql, VersionLabel qlVersion, String operation,
			String baseURI)
			throws MalformedQueryException {
		ParsedOperation parsedOperation;
		QueryParser parser;
		parser = createParser(ql);
		...
		if (QueryLanguage.SPARQL.equals(ql)) {
			...
			if (strippedOperation.startsWith("SELECT") || strippedOperation.startsWith("CONSTRUCT")
				...
				parsedOperation = parser.parseQuery(operation, qlVersion, baseURI);
			} else {
				parsedOperation = parser.parseUpdate(operation, qlVersion, baseURI);
			}
		} else {
	...
	public static ParsedUpdate parseUpdate(QueryLanguage ql, String update, String baseURI)
		...
		return parseUpdate(ql, null, update, baseURI);
	}
	 ...
	 * @throws UnsupportedQueryLanguageException If the specified query language is not supported.
	 */
	public static ParsedUpdate parseUpdate(QueryLanguage ql, VersionLabel qlVersion, String update, String baseURI)
			throws MalformedQueryException, UnsupportedQueryLanguageException {
		QueryParser parser = createParser(ql);
		return parser.parseUpdate(update, qlVersion, baseURI);
	}
	...
	public static ParsedQuery parseQuery(QueryLanguage ql, String query, String baseURI)
			throws MalformedQueryException, UnsupportedQueryLanguageException {
		return parseQuery(ql, null, query, baseURI);
	}
	 ...
	 * @throws UnsupportedQueryLanguageException If the specified query language is not supported.
	 */
	public static ParsedQuery parseQuery(QueryLanguage ql, VersionLabel qlVersion, String query, String baseURI)
			throws MalformedQueryException, UnsupportedQueryLanguageException {
		QueryParser parser = createParser(ql);
		return parser.parseQuery(query, qlVersion, baseURI);
	}
	 ...
	 * @throws UnsupportedQueryLanguageException If the specified query language is not supported.
	 */
	public static ParsedTupleQuery parseTupleQuery(QueryLanguage ql, VersionLabel qlVersion, String query,
			String baseURI)
			throws MalformedQueryException, UnsupportedQueryLanguageException {
		ParsedOperation q = parseQuery(ql, qlVersion, query, baseURI);
	...
	public static ParsedTupleQuery parseTupleQuery(QueryLanguage ql, String query, String baseURI)
			throws MalformedQueryException, UnsupportedQueryLanguageException {
		return parseTupleQuery(ql, null, query, baseURI);
	}
	...
	public static ParsedGraphQuery parseGraphQuery(QueryLanguage ql, String query, String baseURI)
			throws MalformedQueryException, UnsupportedQueryLanguageException {
		return parseGraphQuery(ql, null, query, baseURI);
	}
	 ...
	 * @throws UnsupportedQueryLanguageException If the specified query language is not supported.
	 */
	public static ParsedGraphQuery parseGraphQuery(QueryLanguage ql, VersionLabel qlVersion, String query,
			String baseURI)
			throws MalformedQueryException, UnsupportedQueryLanguageException {
		ParsedOperation q = parseQuery(ql, qlVersion, query, baseURI);
	...
	public static ParsedBooleanQuery parseBooleanQuery(QueryLanguage ql, String query, String baseURI)
			throws MalformedQueryException, UnsupportedQueryLanguageException {
		return parseBooleanQuery(ql, null, query, baseURI);
	}
	 ...
	 * @throws UnsupportedQueryLanguageException If the specified query language is not supported.
	 */
	public static ParsedBooleanQuery parseBooleanQuery(QueryLanguage ql, VersionLabel qlVersion, String query,
			String baseURI)
			throws MalformedQueryException, UnsupportedQueryLanguageException {
		ParsedOperation q = parseQuery(ql, qlVersion, query, baseURI);
